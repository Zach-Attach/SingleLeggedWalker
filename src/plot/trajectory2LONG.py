...
# Creating the plot
plt.figure(1, dpi=1600, figsize=(10, 10))
...
plt.savefig(f"plots/trajectory2_{num}.png", dpi=1600)
...
plt.axhline(y=np.pi/6, color='lightgrey', linestyle='dotted', label='Forward Angle Limit')
plt.axhline(y=-np.pi/6, color='darkgrey', linestyle='dotted', label='Backward Angle Limit')
