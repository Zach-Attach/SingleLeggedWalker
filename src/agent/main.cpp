...
const double RunDuration = 500;//220.0; 
...
// EA params
const int POPSIZE = 500; //8; //96; 80000 = 0.47 
const int GENS = 300;//250; //10; //1000; 	// --- 5000
...
void ResultsDisplay(TSearch &s) {
	...
	BestIndividualFile << phenotype(k) << " " << phenotype(k+1) << endl;
